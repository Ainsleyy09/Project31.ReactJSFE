                    ...
                    <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div className="h-56 w-full overflow-hidden rounded-lg">
                                <a href="#">
                                    <img
                                        className="mx-auto h-full w-full object-cover dark:hidden"
                                        src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"
                                        alt=""
                                    />
                                    <img
                                        className="mx-auto hidden h-full w-full object-cover dark:block"
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div className="h-56 w-full flex justify-center items-center overflow-hidden rounded-lg bg-white dark:bg-gray-800">
                                <a href="#">
                                    <img
                                        className="mx-auto max-h-full object-contain dark:hidden"
                                        src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-light.svg"
                                        alt=""
                                    />
                                    <img
                                        className="mx-auto hidden max-h-full object-contain dark:block"
